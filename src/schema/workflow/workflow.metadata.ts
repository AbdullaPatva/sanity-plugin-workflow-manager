  ...
  defineType({
    ...
    fields: [
      ...
      defineField({
        ...
        type: 'string',
        readOnly: true,
        initialValue: async (p: any, {getClient}: any) => {
      ...
      defineField({
        ...
        fields: [
          defineField({
            ...
            type: 'datetime',
            description: 'When this document should be published',
          }),
          defineField({
            name: 'publishStatus',
          ...
          defineField({
            ...
            type: 'array',
            of: [{ type: 'string' }],
            description: 'Document IDs that must be published before this one',
          }),
        ],
      }),
    ],
